...
class Ui_Button_dialog(object):
    def setupUi(self, Button_dialog):
        ...
        Button_dialog.resize(4000, 3000)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("images/right.jfif"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("images/up.jfif"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.up_pushButton.setIcon(icon2)
        self.up_pushButton.setIconSize(QtCore.QSize(80, 65))
